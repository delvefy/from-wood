...
export const MAJORS: MajorSpec[] = [
  ...
  { id: 'claywork', name: 'Claywork', description: 'Clay pits, clay bricks, ceramics and the kiln', branch: 'tech', x: 1450, y: -280, requires: ['ironworking'], cost: { pickaxe: 2, water: 40 }, time: 1800, resources: ['clay'], recipes: ['brick', 'ceramic', 'pottery_dishes', 'kiln'] },

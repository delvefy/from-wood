...
export const PATHS: PathSpec[] = [
  ...
  { from: 'basic_tools', to: 'woodworking', branch: 'tech', cost: { wood: 6, water: 3 }, time: 45, names: ['Sharp Tools', 'Measured Cuts'] },
  ...
  { from: 'runic_industry', to: 'arcane_machinery', branch: 'magitech', cost: { steel: 12, mana_dust: 12 }, time: 7200, names: ['Mana Flywheels', 'Alloy Trials', 'Humming Frames'] },
